...
public class OperationalPropertyDefinition {

    private String id; // OBIS Code, e.g. 1.7.0
    private String name; // e.g. posActInstPower
    private Unit[] allowedUnits;
    //TODO: reference to physicalMeterIds?
    public OperationalPropertyDefinition(String id, String name, Unit[] allowedUnits) {
        this.id = id;
        this.name = name;
